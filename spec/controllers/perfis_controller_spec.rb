...
describe PerfisController do
  ...
  # PerfisController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET index" do
    it "assigns all perfis as @perfis" do
      ...
      assigns(:perfis).should eq([perfil])
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved perfil as @perfil" do
        ...
        post :create, {:perfil => { "tipo" => "invalid value" }}, valid_session
        assigns(:perfil).should be_a_new(Perfil)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested perfil" do
        perfil = Perfil.create! valid_attributes
        # Assuming there are no other perfis in the database, this
        # specifies that the Perfil created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Perfil.any_instance.should_receive(:update).with({ "tipo" => "MyString" })
        put :update, {:id => perfil.to_param, :perfil => { "tipo" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the perfil as @perfil" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Perfil.any_instance.stub(:save).and_return(false)
        put :update, {:id => perfil.to_param, :perfil => { "tipo" => "invalid value" }}, valid_session
        assigns(:perfil).should eq(perfil)
      end
